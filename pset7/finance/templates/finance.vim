...
silent only
cd ~/workspace/pset7/finance/templates
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/.vimrc
badd +82 ~/workspace/pset7/finance/application.py
badd +1 ~/workspace/pset7/finance/helpers.py
badd +1 apology.html
badd +1 layout.html
badd +1 login.html
args apology.html layout.html login.html
edit ~/workspace/pset7/finance/application.py
...
exe 'vert 1resize ' . ((&columns * 100 + 98) / 197)
exe 'vert 2resize ' . ((&columns * 96 + 98) / 197)
argglobal
edit ~/workspace/pset7/finance/application.py
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
edit ~/workspace/pset7/finance/helpers.py
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
